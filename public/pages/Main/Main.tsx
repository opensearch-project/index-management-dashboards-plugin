...
import { DataSourceMenuContext, DataSourceMenuProperties, DataSourceMenuReadOnlyContext } from "../../services/DataSourceMenuContext";
                ...
                {(services: BrowserServices | null) =>
                  services && (
                    <ModalProvider>
                      ...
                      >
                        <DataSourceMenuReadOnlyContext.Provider
                          value={{
